  ...
  return (
    <div className="p-4">
      ...
      <div className="border border-color flex flex-row px-1.5 gap-1">
        ...
        <div className="py-2.5 px-2 flex flex-row items-center gap-2 border-b-primary cursor-pointer box-border hover:border-b-2 hover:-mb-[2px] text-muted-foreground">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-cable w-4 h-4"
          >
        ...
        <div className="py-2.5 px-2 flex flex-row items-center gap-2 border-b-primary cursor-pointer box-border hover:border-b-2 hover:-mb-[2px] text-muted-foreground">
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="lucide lucide-shield-alert w-4 h-4"
          >
        ...
        <div className="space-y-2">
          <div className="flex flex-col gap-2">
            <div className="w-[300px]">
              <p className="text-sm font-bold">Project code</p>
